...
//            
//            // Transaction.java 파일에 맞게 getter 사용
...
//                while (rs.next()) {
//                    // Transaction.java의 ID 포함 생성자에 맞게 수정
...
//        // DB의 PK 컬럼이 'transactionId'가 아닌 'id'일 수 있음
//        // 만약 DB 컬럼명이 'transactionId'가 맞다면 "id = ?" 를 "transactionId = ?"로 변경
...
//
//    /**
//     * 특정 사용자의 특정 월에 해당하는 모든 거래 내역을 조회 (Read)
//     */
...
//
//    /**
//     * 그래프 기능을 위한 메서드 1: 월별 총 수입/지출 합계 조회
//     */
...
//
//    /**
//     * 그래프 기능을 위한 메서드 2: 월별 카테고리별 합계 조회
//     */
...
//
//    /**
//     * 그래프 기능을 위한 메서드 3: 연간 월별 수입/지출 합계 조회
